package com.esapos.lib.Controller.Esc;

/**
 * Created by VickyLeu on 2016/8/5.
 *
 * @Author Vickyleu
 * @Company Esapos
 * @Class
...
public class EscCommand {
    ...
    USBPort Command = null;

    public EscCommand(USBPort mUSBPort) {
        this.Command = mUSBPort;
    }

    private void addArrayToCommand(byte[] array) {
        this.Command.AddData2Printer(array);
    }
    ...
    private void addStrToCommand(String str) {
        ...
        if (!str.equals("")) {
            ...
            this.Command.AddData2Printer(bs);
        }
    ...
    public void addRastBitImage(Bitmap bitmap, int nWidth, int nMode) {
        if (bitmap != null) {
            ...
            this.Command.AddData2Printer(codecontent);
    ...
    public void addCODE128(String content) {
        byte[] barcodebytes = content.getBytes();
        ...
        result[idx] = 0;
        this.Command.AddData2Printer(result);
